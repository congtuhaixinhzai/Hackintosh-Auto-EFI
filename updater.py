...
class Updater:
    def __init__(self):
        ...
        self.download_repo_url = "https://github.com/congtuhaixinhzai/Hackintosh-Auto-EFI/archive/refs/heads/main.zip"
    ...
    def get_latest_sha_version(self):
        ...
        try:
            commits = self.github.get_commits("congtuhaixinhzai", "Hackintosh-Auto-EFI")
    ...
    def update_files(self):
        ...
        try:
            target_dir = os.path.join(self.temporary_dir, "OpCore-HC-main")
            if not os.path.exists(target_dir):
                target_dir = os.path.join(self.temporary_dir, "main", "OpCore-HC-main")
